...
- Create Angular project with ng: `ng new lojadediversidades.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`lojadediversidades.client.esproj`).
